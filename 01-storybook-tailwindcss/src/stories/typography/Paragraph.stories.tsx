...
export const LeftAligned: StoryObj<StoryProps> = {
  args: {
    align: 'left',
    paragraphText: 'This is a left-aligned paragraph with extended content to better demonstrate the alignment. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.',
  },
  render: ({ paragraphText, ...args }) => <Paragraph {...args}>{paragraphText}</Paragraph>,
};
...
export const CenterAligned: StoryObj<StoryProps> = {
  args: {
    align: 'center',
    paragraphText: 'This is a center-aligned paragraph with extended content to better demonstrate the alignment. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.',
  },
  render: ({ paragraphText, ...args }) => <Paragraph {...args}>{paragraphText}</Paragraph>,
};
...
export const RightAligned: StoryObj<StoryProps> = {
  args: {
    align: 'right',
    paragraphText: 'This is a right-aligned paragraph with extended content to better demonstrate the alignment. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.',
  },
  render: ({ paragraphText, ...args }) => <Paragraph {...args}>{paragraphText}</Paragraph>,
};
